...
public class PanelProgramacionView extends JFrame {
    ...
    public void inicializarComponentes() {
       ...
       btnAbrePinza= new JButton(new ImageIcon("abrir.png"));
       btnCierraPinza= new JButton(new ImageIcon("cerrar.png"));
       //Codo
       lblCodo= new JLabel("Codo");
       btnAvanzaCodo= new JButton(new ImageIcon("avanzarArriba.png"));
       btnRetrocedeCodo=new JButton(new ImageIcon("avanzarAbajo.png"));
       //Hombro
       lblHombro= new JLabel("Hombro");
       btnLevantarHombro=new JButton(new ImageIcon("arriba.png"));
       btnBajarHombro=new JButton(new ImageIcon("abajo.png"));
       //Cintura
       lblCintura= new JLabel("Cintura");
       btnGirarCintura= new JButton(new ImageIcon("rotacion.png"));
